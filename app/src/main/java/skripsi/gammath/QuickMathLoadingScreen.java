...
public class QuickMathLoadingScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean quickMathTimer = sharedPref.getBoolean(nyc.tanjim.mathtank.SettingsActivity.KEY_TIMER,false);
        if(darkModePref){
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(getApplicationContext(), nyc.tanjim.mathtank.QuickMath.class));
                finish();
            }
        },loadingScreenTime);
